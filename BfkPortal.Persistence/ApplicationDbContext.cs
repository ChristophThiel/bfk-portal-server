        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (configuration["Provider"] == "PostgreSql")
            {
                ...
                builder.Append("User ID=")
                    .Append(Environment.GetEnvironmentVariable("POSTGRES_USER", EnvironmentVariableTarget.User))
                    .Append(";Password=")
                    .Append(Environment.GetEnvironmentVariable("POSTGRES_PASSWORD", EnvironmentVariableTarget.User))
                    .Append(";Host=")
                    .Append(Environment.GetEnvironmentVariable("POSTGRES_URL", EnvironmentVariableTarget.User))
                    .Append(";Port=5432;Database=")
                    .Append(Environment.GetEnvironmentVariable("POSTGRES_DATABASE", EnvironmentVariableTarget.User))
                    .Append(";Pooling=true;");
                optionsBuilder.UseNpgsql(builder.ToString());
